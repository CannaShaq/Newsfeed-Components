...
const createArticle = (title, date, pOne, ptwo, pThree) => {
...
const articleStuff = createArticle('test title', '04/04/1994', 'test para', 'test graph', 'testing 123');

article.appendChild(articleStuff);